...
export const catalogueSections: CatalogueSection[] = [
  ...
  { key: "Griping-Components",                      title: "Gripping Components",                       product: "JID-GRIPPING-COMPONENTS",         families:    9, codes:   10,
    alsoProducts: ["JID-CONVEYOR-GRIPPING-UNITS"],
    note: "Seven of the nine families are conveyors (KPQ/KPA/KPG/KQJ/KQN/KRA/KSD) and two are gripping PPUs (ZBC21/22), so this section serves the Conveyor & Gripping Units catalogue as well. ilovepdf_merged.pdf in the source folder is a duplicate of this same content under a meaningless name." },
