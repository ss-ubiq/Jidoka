...
export default async function Page({ searchParams }: { searchParams: Promise<{ ref?: string; qty?: string; notes?: string; via?: string }> }) {
  const { ref, qty, notes, via } = await searchParams;
  return (
    <FormPage
      mode="quote"
