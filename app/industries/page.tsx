...
export default function Page() {
  return <DiscoveryHub eyebrow="Industries" title="Find components by industry" lead="Explore the applications, solutions and component families most relevant to your industry." basePath="/industries" items={industries} crumbs={[{ label: "Home", href: "/" }, { label: "Industries" }]} />;
}
